...
<meta name="description" content="Bangladesh Institute of Management Result Publication System">
...
<header class="clearfix vertical-padding header-area">

	<div class="logo xlarge-push-left large-push-left no-margin">
		<a href="#"> <img src="<?php echo base_url('assets/img/bim_logo.png');?>" class="left-space" alt="BIM Logo"></a>
	</div>
	<div class="top-space">
		<h1 class="left-space" style="color: #fff;">Bangladesh Institute of Management</h1>
	</div>
	...
	<nav
		...
		<ul class="menu horizontal red">
			...
			<li><a href="<?php echo site_url('user/login', 'Login'); ?>">Login</a></li>
			<li><a href="<?php echo site_url('user/logout', 'Logout'); ?>">Logout</a></li>
		</ul>
	</nav>
